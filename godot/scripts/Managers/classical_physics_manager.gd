...
class_name ClassicalPhysicsManager
extends Node2D


@export var delta_scaler : float = 0.01

@onready var _applied_force = preload("res://scripts/resources/forces/applied_force.tres")
@onready var _drag_force = preload("res://scripts/resources/forces/drag_force.tres")
@onready var _frictional_force = preload("res://scripts/resources/forces/frictional_force.tres")
@onready var _gravitational_force = preload("res://scripts/resources/forces/gravitational_force.tres")
@onready var _movement_input_force = preload("res://scripts/resources/forces/movement_input_force.tres")
@onready var _normal_force = preload("res://scripts/resources/forces/normal_force.tres")
# @onready var _spring_force = preload("res://scripts/resources/forces/spring_force.tres")
